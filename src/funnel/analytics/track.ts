...
export const EVENTS = {
  ...
  // Fires when user starts typing card details — strong purchase-intent signal.
  CARD_DETAILS_STARTED: "card_details_started",
  // Fires when the user submits card details.
