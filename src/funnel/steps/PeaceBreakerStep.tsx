...
const OPTIONS = [
  { id: "dry-texts", emoji: "🙈", label: "Dry texts" },
  { id: "slow-replies", emoji: "⏰", label: "Slow replies (3+ hours)" },
  {
  ...
  },
  {
    id: "no-label",
    emoji: "🚩",
    label: "I'm not ready for a label right now",
  },
  {
    id: "watched-story",
    emoji: "😫",
    label: "Watched my story but didn't text back",
  },
] as const;
...
export function PeaceBreakerStep() {
  ...
  const handleSelect = (id: string) => {
    ...
    setSelected(id);
    setAnswer("peaceBreaker", id);
    track(EVENTS.ANSWER_SELECTED, { step: "peace_breaker", value: id });
    setAmplitudeUserProperties({ peace_breaker: id });
